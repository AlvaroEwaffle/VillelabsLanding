...
const post = getBlogPost('ai-chatbot-cost-chile-2026')!;

export const metadata: Metadata = {
  title: post.title,
  description: post.excerpt,
  keywords: post.keywords,
  alternates: { canonical: `${siteUrl}/blog/ai-chatbot-cost-chile-2026` },
  openGraph: {
    title: `${post.title} | Villelabs Blog`,
    description: post.excerpt,
    url: `${siteUrl}/blog/ai-chatbot-cost-chile-2026`,
    type: 'article',
