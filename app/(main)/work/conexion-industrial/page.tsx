...
const caseStudy = getCaseStudy('conexion-industrial')!;

export const metadata: Metadata = {
  title: `${caseStudy.client} — Caso de Éxito | Villelabs`,
  description: `${caseStudy.title}. ${caseStudy.result}.`,
  alternates: { canonical: `${siteUrl}/work/conexion-industrial` },
  openGraph: {
    title: `${caseStudy.client} | Villelabs`,
    description: `${caseStudy.title}. ${caseStudy.result}.`,
    url: `${siteUrl}/work/conexion-industrial`,
    images: [{ url: caseStudy.heroImage, alt: caseStudy.client }],
  },
};

export default function ConexionIndustrialPage() {
